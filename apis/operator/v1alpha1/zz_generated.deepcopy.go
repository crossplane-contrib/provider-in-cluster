...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OperatorExternalStatus) DeepCopyInto(out *OperatorExternalStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OperatorExternalStatus.
func (in *OperatorExternalStatus) DeepCopy() *OperatorExternalStatus {
	if in == nil {
		return nil
	}
	out := new(OperatorExternalStatus)
	in.DeepCopyInto(out)
	return out
}
