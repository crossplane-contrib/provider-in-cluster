...
// PostgresParameters define the desired state of a Postgres database
type PostgresParameters struct {
	...
	// +optional
	// +immutable
	MasterPasswordSecretRef *v1.SecretKeySelector `json:"masterPasswordSecretRef,omitempty"`
}

// An PostgresSpec defines the desired state of a Postgres instance.
...
// An PostgresStatus represents the observed state of a Postgres instance.
